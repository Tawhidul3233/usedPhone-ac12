          ...
          <div>
               <div className="navbar bg-green-500">
                    <div className="navbar-start">
                         ...
                         <div className='flex'>
                              <img className=' border rounded-lg' style={{ width: '50px', Height: '50px' }} src="https://i.ibb.co/0XgHhcc/favicon.png" alt="" />
                              <a href='/' className="btn btn-ghost normal-case text-xl"> UsedPhone </a>
                         </div>
                    </div>
